def preprocess(json_input):
    ...
    message = ""
    area = 1
    if type(json_input["data"]["area"]) != "int":
        area = 0
    ...
    if area == 0:
        ...
        error = True    # we can remove postcodes list from below message
    ...
    if error:   # return without any clean because mandotories are wrong
        ...
        if json_input["data"]["full-address"] != "":
...
sample_json_input = {
    "data": {
        ...
        "rooms-number": 1,
        "zip-code": 1000,  # only 4 integers, >1000 & <9999
        "land-area": "djfg",  # Optional
        "garden": 1,  # Optional
        "garden-area": "djfg",  # Optional
        "equipped-kitchen": 1,  # Optional
        "full-address": "djfg",  # Optional
        "swimmingpool": 1,  # Optional
        "furnished": 1,  # Optional
        "open-fire": 1,  # Optional
        "terrace": 1,  # Optional
        "terrace-area": "djfg",  # Optional
        "facades-number": "djfg",  # >1 & <10 #Optional
